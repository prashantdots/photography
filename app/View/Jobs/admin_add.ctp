...
$(function() {
	...
	$('.preview').click(function(){
		$('#JobAddForm').attr('action','<?php echo Router::url('/', true);?>admin/jobs/add/preview');
		/*$('#JobAddForm').attr('target','_blank');*/
		$('#JobAddForm').submit();
  ...
  <div id="main">
    ...
    <div id="content">
      ...
      <div class="box full">
        ...
        <!-- End Box Head -->
        <?php echo $this->Form->create('Job', array('action' => 'add')); ?>
        <!-- Form -->
        <div class="form">
          <ul class="fields">
	        <li>
            ...
            <li>
              ...
              <?php echo $this->Form->input('order_date', array('type'=>'text','id'=>'order_date','label' => false,'div'=>false,'readonly'=>'readonly'));?> </li>
			  
			 <li>
              <label>Shoot Date <span>(Required Field)</span></label>
              <?php echo $this->Form->input('shoot_date', array('type'=>'text','id'=>'shoot_date','label' => false,'div'=>false,'readonly'=>'readonly'));?> </li>
			 ...
			 <li>&nbsp;</li>
              ...
              <?php echo $this->Form->input('dress_code', array('label' => false,'div'=>false,'value'=>'Licklist uniform plus own clothing as required.No trainers'));?> </li>
			 ...
			 <li>
			  ...
			  <li><h4 style="color:#E532A0;font-size:14px;">Other Details</strong></h4> </li>
			   <li>&nbsp;</li>
			  <li>
              <label>Primary Licklist Contact <span>(Required Field)</span></label>
              <?php echo $this->Form->input('personal_licklist_contact', array('label' => false,'value'=>'Ben Jennings','div'=>false));?> </li>
        ...
        <!-- Form Buttons -->
        <div class="buttons">
		        <?php echo $this->Form->button('Preview Call Sheet',array('type' => 'button','div'=>false,'class' => 'button preview', 'title' => 'Preview'));?>
