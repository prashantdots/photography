...
<div class="shell">
		...
		<div id="main">
		<a href="<?php echo Router::url('/', true);?>admin/jobs/add?jobtype=optionPhotographer" class="add-button" style="float:right;" ><span>Add Job</span></a>
		&nbsp;&nbsp;
		<br /><br /><br />
			<div class="cl">&nbsp;</div>
					...
					<div class="table">
					 ...
					 ?>
							...
							echo $this->Common->getJobUploadDate($job['Job']['id']);
							 ?>&nbsp;</td>
							<td class="actions">
								<?php echo $this->Form->postLink(__('Live'), array('action' => 'live', $job['Job']['id']), array('class'=>'ico edit'), __('Are you sure want to live this job?', $job['Job']['id'])); ?>
							</td>
							</tr>
					<?php 
					$num++;
