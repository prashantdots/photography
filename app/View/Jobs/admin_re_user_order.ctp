          ...
          <ul class="fields">
		    ...
		    <li>
			 ...
			 <li>
              ...
              <?php echo $this->Form->input('agreed_photographer_fee', array('label' => false,'div'=>false));?> </li>
			  
			 <li>
              <label>Shoot Gross Value<span>(Required Field)</span></label>
              <?php echo $this->Form->input('agreed_venue_fee', array('label' => false,'div'=>false));?> </li> 
		   
            <li>
              <label>Order Dtae <span>(Required Field)</span></label>
              <?php echo $this->Form->input('order_date', array('type'=>'text','id'=>'order_date','label' => false,'div'=>false));?> </li>
			  
			 <li>
              <label>Shoot Dtae <span>(Required Field)</span></label>
			 ...
			 <li>&nbsp;</li>
			  ...
			  echo $this->Form->input('cover_photographer', array('type'=>'select','options'=>$photographersArr,'empty'=>'-Select-','label' => false,'div'=>false));?> </li>
			 ...
			 <li>
			  ...
			  <li>
              <label>Message <span>(Other)</span></label>
