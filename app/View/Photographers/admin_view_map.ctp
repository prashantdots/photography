	...
	function showPosition(position)
	  {
		...
		// var Lat=51.519897;
		 ...
		 $('#lon').val(Lon);
			 ...
			 <?php
			 $i=0;
			 foreach($photographers as $location){ ?>
			 
		     locations[<?php echo $i;?>] = ['<?php echo $location['address'];?>'+'<br/>'+'<?php echo $location['town'];?>'+'<br/>'+'<?php echo $location['county'];?>'+'<br/>'+'<?php echo $location['postcode'];?>'+'<br/>'+'<?php echo $location['mobile'];?>',<?php echo $location['lat'];?>,<?php echo $location['long'];?>]
			 ...
			 ?>
					...
					for (i = 0; i < locations.length; i++) {  
					  if(locations[i][1]==Lat &&  locations[i][2]==Lon){
