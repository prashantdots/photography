<div class="shell">
		...
		<div class="small-nav">
		<?php
		$this->Html->addCrumb('Photographer');
		...
		<div id="main">
	<a href="<?php echo Router::url('/', true);?>admin/photographers/add" class="add-button" style="float:right;"><span>Add new photographer</span></a>
	<a href="<?php echo Router::url('/', true);?>admin/photographers/allArchivePhotographer" class="add-button" ><span>Archive Photographers</span></a>	&nbsp;&nbsp;
	<br /><br /><br />
